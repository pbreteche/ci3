...
CREATE TABLE `has_skill` (
  ...
  KEY `skill` (`skill_id`),
  CONSTRAINT `pokemon` FOREIGN KEY (`pokemon_id`) REFERENCES `pokemon` (`id`),
...
INSERT INTO `has_skill` VALUES (1,1),(2,2),(2,3);
...
INSERT INTO `pokemon` VALUES (1,'Bulbasaur',71,6900,'male','Grass'),(2,'Pidgeot',150,39500,'female','Normal');
...
INSERT INTO `skill` VALUES (1,'Overgrow'),(2,'Keen Eye '),(3,'Tangle feet');
...
-- Dump completed on 2018-02-23 12:18:22
